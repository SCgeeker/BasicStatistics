...
因為前面示範的GSS2010沒有精確的名義尺度資料，我們從研究中心網站下載[原始GSS2010的SPSS存檔](http://gss.norc.org/Documents/spss/2010_spss.zip)，取其中的性別(sex)變項，配合這段示範演練。這個變項資料只有兩種數值：1與2，分別代表男性與女性。從圖\@ref(fig:nominate-demo)的JASP操作與輸出畫面，你可以注意到變項圖示是![](images/icon/jasp-variable-nominal.png){width=10%}，表示以數字代表性別，因此**報表裡的眾數是2**，表示2010年調查的受訪者超過一半是女性。
