...
knitr::include_graphics("images/jasp_file.jpg")
```
...
knitr::include_graphics("images/jasp_common.jpg")
```
...
```{r jamovi-blank, out.width='70%', fig.cap="jamovi起始畫面", fig.align='center', echo=FALSE}
knitr::include_graphics("images/jamovi_blank.jpg")
```

使用者需要點擊圖 \@ref(fig:jamovi-blank) 紅色圓圈處的三條橫線，才能打開如圖 \@ref(fig:jamovi-menu) 的檔案選單，選擇開啟存在本機的檔案。

```{r jamovi-menu, out.width='70%', fig.cap="jamovi檔案管理選單", fig.align='center', echo=FALSE}
knitr::include_graphics("images/jamovi_menu.jpg")
```
...
```{r jamovi-modules, out.width='80%', fig.cap="jamovi模組管理選單", fig.align='center', echo=FALSE}
knitr::include_graphics("images/jamovi_modules.png")
```
...
```{r jamovi-Rj, out.width='80%', fig.cap="設定Rj使用已安裝的R套件", fig.align='center', echo=FALSE}
knitr::include_graphics("images/jamovi_Rj_setting.png")
```
...
```{r JASP-pref-ana, out.width='80%', fig.cap="JASP設定選單–小數點位數設定", fig.align='center', echo=FALSE}
knitr::include_graphics("images/JASP_pref_ana.png")
```


```{r JASP-pref-missing, out.width='80%', fig.cap="JASP設定選單–遺漏值設定", fig.align='center', echo=FALSE}
knitr::include_graphics("images/JASP_pref_missing.png")
```
...
```{r jamovi-preference, out.width='80%', fig.cap="jamovi設定選單", fig.align='center', echo=FALSE}
knitr::include_graphics("images/jamovi_preference.PNG")
```
...
```{r csv-preview, out.width='80%', fig.cap="上圖：使用純文字編輯器直接開啟csv檔；下圖：使用Excel自動匯入功能開啟csv檔", fig.align='center', echo=FALSE}
...
```{r JASP-osf, out.width='80%', fig.cap="在OSF網站瀏覽JASP分析報表，圖中是Emily Rosa的範例。", fig.align='center', echo=FALSE}
knitr::include_graphics("images/JASP_osf.PNG")
```
