...
<div class="figure" style="text-align: center">
<img src="images/csv_to_excel.png" alt="使用純文字編輯器直接開啟csv檔(上)；使用Excel自動匯入功能開啟csv檔(下)" width="80%" />
<p class="caption">(\#fig:csv-preview)使用純文字編輯器直接開啟csv檔(上)；使用Excel自動匯入功能開啟csv檔(下)</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/csv_to_excel.png" alt="在OSF網站瀏覽JASP分析報表，圖中是Emily Rosa的範例。" width="80%" />
