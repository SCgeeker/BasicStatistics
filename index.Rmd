...
這本書初版使用[趙鵬博士](http://www.pzhao.org/zh/)改良的R套件[bookdownplus](https://github.com/pzhaonet/bookdownplus)編寫，目前使用[謝益輝博士](https://yihui.name/)開發的[bookdown](https://bookdown.org/yihui/bookdown/)編寫及更新。歡迎到[個人部落格](http://scchen.com/zh/post/basic-statistics/)或[Github](https://github.com/SCgeeker/BasicStatistics/issues)留言，給予本書批評與建議。如果學習者有興趣，歡迎自行取用本書的[源始碼](https://github.com/SCgeeker/BasicStatistics)，希望能成為你人生的第一套R學習範例。以下是完成第一版的R環境資訊：
